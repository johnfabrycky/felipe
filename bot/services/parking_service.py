...
class ParkingService:
    ...
    def _cancel_action_sync(self, user_id, action_type, record_id):
        ...
        if action_type == "offer":
            ...
            spot_label = "Spot" if offer['spot_number'] in STAFF_SPOTS else f"Spot {offer['spot_number']}"
        ...
        spot_label = "Spot" if reservation['spot_number'] in STAFF_SPOTS else f"Spot {reservation['spot_number']}"
